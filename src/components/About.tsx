          ...
          <div className="grid lg:grid-cols-5 gap-10 items-center max-w-5xl mx-auto">
            ...
            <motion.div className="lg:col-span-3 space-y-6" variants={itemVariants}>
              <p className="text-muted-foreground text-lg leading-relaxed text-center lg:text-left">
                Sou desenvolvedor full stack de Carlos Barbosa, com 18 anos. Construo aplicações
                web completas — do frontend ao backend — unindo design, performance e código limpo.
                Estágiei na{" "}
                <span className="text-primary font-medium">Blasternet Telecom</span>, onde
                desenvolvi um chatbot com IA para WhatsApp em React e Laravel.
              </p>
